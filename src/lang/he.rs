...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_password_tip", "אמת סיסמת LUODA"),
        ...
        ("upgrade_server_pro_to_{}_tip", "אנא שדרג את LUODA Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("upgrade_remote_client_to_{}_tip", "אנא שדרג את לקוח LUODA לגרסה {} או חדשה יותר בצד המרוחק!"),
