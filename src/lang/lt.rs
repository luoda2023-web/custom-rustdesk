...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "Įveskite kliento LUODA slaptažodį"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės LUODA klientą į {} ar naujesnę versiją!"),
