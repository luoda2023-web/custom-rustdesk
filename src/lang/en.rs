...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("doc_mac_permission", "https://luoda.com/docs/en/client/mac/#enable-permissions"),
        ...
        ("verify_password_tip", "Verify LUODA password"),
        ...
        ("upgrade_server_pro_to_{}_tip", "Please upgrade LUODA Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://luoda.com/docs/en/client/linux/#x11-required"),
        ...
        ("upgrade_remote_client_to_{}_tip", "Please upgrade the LUODA client to version {} or newer on the remote side!"),
