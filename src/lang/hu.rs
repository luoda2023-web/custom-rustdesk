...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "A távoli vezérléshez a LUODAnek „Kisegítő lehetőségek” engedélyre van szüksége"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a LUODA nem fut megfelelően, mint ellenőrzött webhely."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a LUODA ablak nyitva van."),
