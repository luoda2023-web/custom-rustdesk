...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_password_tip", "LUODA jelszó megerősítése"),
        ...
        ("upgrade_server_pro_to_{}_tip", "Frissítse a LUODA Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("upgrade_remote_client_to_{}_tip", "Frissítse a LUODA klienst {} vagy újabb verziójára a távoli oldalon!"),
