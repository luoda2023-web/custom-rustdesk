...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_password_tip", "Επιβεβαιώστε τον κωδικό του LUODA"),
        ...
        ("upgrade_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε το LUODA Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("upgrade_remote_client_to_{}_tip", "Αναβαθμίστε τον πελάτη LUODA στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
