...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_password_tip", "LUODA のパスワードを確認する"),
        ...
        ("upgrade_server_pro_to_{}_tip", "LUODA Server Pro をバージョン {} 以上にアップグレードしてください！"),
        ...
        ("upgrade_remote_client_to_{}_tip", "リモート側の LUODA クライアントをバージョン {} 以上にアップグレードしてください！"),
