...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비됨"),
        ("Established", "연결됨"),
        ("connecting_status", "LUODA 네트워크에 연결하는 중..."),
        ...
        ("OS Password", "OS 비밀번호"),
        ("install_tip", "UAC(사용자 계정 컨트롤)로 인해 일부 원격 제어 기능이 제한될 수 있습니다. 모든 기능을 사용하려면 LUODA를 시스템에 설치해야 합니다."),
        ("Click to upgrade", "업그레이드하려면 클릭하세요."),
        ("Click to download", "다운로드하려면 클릭하세요."),
        ("Click to update", "업데이트하려면 클릭하세요."),
        ("Configure", "구성"),
        ("config_acc", "이 데스크톱을 원격으로 제어하려면 LUODA에 '손쉬운 사용' 권한을 부여해야 합니다."),
        ("config_screen", "이 데스크톱 화면을 원격으로 보려면 LUODA에 '화면 기록' 권한을 부여해야 합니다."),
        ("Installing ...", "설치 중입니다..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("android_input_permission_tip1", "원격 마우스 또는 터치로 Android 기기를 제어하려면 LUODA의 '손쉬운 사용' 서비스 사용을 허용해야 합니다."),
        ("android_input_permission_tip2", "시스템 설정의 [설치된 서비스]에서 [LUODA Input] 서비스를 찾아 활성화하세요."),
        ...
        ("Turned off", "꺼짐"),
        ("Language", "언어"),
        ("Keep LUODA background service", "LUODA 백그라운드 서비스 실행 유지"),
        ("Ignore Battery Optimizations", "배터리 최적화에서 제외"),
        ("android_open_battery_optimizations_tip", "배터리 최적화 대상에서 제외하려면, LUODA 앱 설정 페이지로 이동하여 [배터리] 항목에서 [제한 없음]을 선택하세요."),
        ...
        ("elevated_foreground_window_tip", "원격 데스크톱의 현재 창을 제어하려면 관리자 권한이 필요합니다. 일시적으로 마우스와 키보드를 사용할 수 없다면, 상대방에게 현재 창을 최소화하도록 요청하거나 연결 관리 창에서 '권한 상승'을 클릭하세요. 이 문제를 방지하려면 원격 기기에 LUODA를 설치하는 것이 좋습니다."),
        ("Disconnected", "연결 끊김"),
        ("Other", "기타"),
        ...
        ("config_input", "키보드로 원격 데스크톱을 제어하려면 LUODA에 '입력 모니터링' 권한을 허용해 주세요."),
        ("config_microphone", "마이크로 오디오를 전송하려면 LUODA에 '오디오 녹음' 권한을 허용해 주세요."),
        ...
        ("still_click_uac_tip", "원격 사용자는 LUODA를 실행하는 UAC(사용자 계정 컨트롤) 창에서 '예'를 클릭해야 합니다."),
        ...
        ("scam_text1", "모르는 사람이 LUODA 사용을 요청하며 접근하는 경우, 사기일 수 있으니 즉시 연결을 종료하세요."),
        ...
        ("selinux_tip", "SELinux가 활성화된 경우 LUODA가 호스트로 제대로 작동하지 않을 수 있습니다."),
        ("Change view", "보기 변경"),
        ("Big tiles", "큰 타일"),
        ("Small tiles", "작은 타일"),
        ("List", "리스트"),
        ...
        ("allow-only-conn-window-open-tip", "LUODA 창이 열려 있는 경우에만 연결 허용"),
        ...
        ("floating_window_tip", "LUODA 백그라운드 서비스 유지를 권장합니다."),
        ...
        ("View camera", "카메라 보기"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "원격 기기의 LUODA 클라이언트를 {} 버전 이상으로 업그레이드하십시오!"),
