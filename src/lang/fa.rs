...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_password_tip", "رمز عبور LUODA را تأیید کنید"),
        ...
        ("upgrade_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید LUODA Server Pro لظفا"),
        ...
        ("upgrade_remote_client_to_{}_tip", "لطفاً LUODA را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
