...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_password_tip", "Verifica la contrasenya del LUODA"),
        ...
        ("upgrade_server_pro_to_{}_tip", "Actualitzeu el LUODA Server Pro a la versió {} o superior!"),
        ...
        ("upgrade_remote_client_to_{}_tip", ""),
        ("d3d_render_tip", ""),
