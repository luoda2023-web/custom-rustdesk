...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Do cơ chế UAC, LUODA có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt LUODA vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho LUODA."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho LUODA."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [LUODA Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep LUODA background service", "Giữ dịch vụ LUODA chạy nền"),
        ...
        ("verify_password_tip", "Xác thực mật khẩu LUODA"),
        ...
        ("scam_text2", "Chỉ sử dụng LUODA với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ LUODA mở"),
        ...
        ("floating_window_tip", "Giữ LUODA trên cùng"),
        ...
        ("upgrade_remote_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
