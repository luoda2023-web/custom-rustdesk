...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 LUODA 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("verify_password_tip", "验证 LUODA 密码"),
        ...
        ("upgrade_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ...
        ("upgrade_remote_client_to_{}_tip", "请在远程端将 LUODA 客户端升级至版本 {} 或更新版本！"),
