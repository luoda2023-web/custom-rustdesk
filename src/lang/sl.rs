...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem LUODA..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, LUODA v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate LUODAu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate LUODAu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno LUODAu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »LUODA Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep LUODA background service", "Ohrani LUODAovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije LUODA, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "LUODA potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "LUODA potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za LUODA"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite LUODA, prekinite klic in program zaprite."),
        ("scam_text2", "LUODA omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite LUODA Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo LUODA"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno LUODAa odprto"),
        ...
        ("floating_window_tip", "Pomaga pri LUODA storitvi v ozadju"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite LUODA odjemalec na različico {} ali novejšo na oddaljeni strani."),
