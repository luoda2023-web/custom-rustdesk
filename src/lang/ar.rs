...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_password_tip", "تحقق من كلمة مرور LUODA"),
        ...
        ("upgrade_server_pro_to_{}_tip", "ترقية خادم LUODA Pro إلى {}"),
        ...
        ("upgrade_remote_client_to_{}_tip", "ترقية عميل LUODA البعيد إلى {}"),
