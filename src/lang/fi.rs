...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_password_tip", "Vahvista LUODA salasanasi kirjautumista varten"),
        ...
        ("upgrade_server_pro_to_{}_tip", "Päivitä LUODA Server Pro versioon {} jatkaaksesi."),
        ...
        ("upgrade_remote_client_to_{}_tip", "Päivitä etä-LUODA-asiakasversioon {} yhteensopivuuden takaamiseksi"),
